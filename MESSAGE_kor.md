...
```
# 메시지 유형 및 생성 방법
[quick reply buttons](https://developers.line.biz/en/docs/messaging-api/using-quick-reply/)는 아래 모든 메시지에 포함 될 수 있습니다.
...
PackageId / StickerId는 [List of available stickers](https://developers.line.biz/en/docs/messaging-api/sticker-list/)를 참조하세요
```csharp
...
* [flex message simulator](https://developers.line.biz/flex-simulator)의 각 showcase에 있는 메시지 예제는 
